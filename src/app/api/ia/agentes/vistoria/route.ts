...
export async function POST() {
  ...
  try {
    const prompt = `Você é o Agente de Vistoria do NuFlow — um consultor de gestão e produtividade audiovisual. Faça uma auditoria COMPLETA e PROFUNDA do sistema.
