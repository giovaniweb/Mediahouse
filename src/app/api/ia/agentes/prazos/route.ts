...
export async function POST() {
  ...
  try {
    const prompt = `Você é o Agente de Prazos e Produtividade do NuFlow. Sua missão é garantir que os projetos avancem no tempo certo.
