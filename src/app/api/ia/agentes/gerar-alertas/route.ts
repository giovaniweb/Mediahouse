...
export async function POST() {
  ...
  try {
    const prompt = `Você é o Agente de Vigilância do NuFlow. Sua missão é analisar o estado atual do sistema e gerar alertas para TODOS os problemas que encontrar.
